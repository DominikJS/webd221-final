<?php include "includes/header.php"; ?>
		...
		<section id="about">
			...
			<article class="aboutMain clearfix">
				<div class="container center">
					<h6>Who <span class="orange">We Are</span></h6>
			...
			<article>
				<div class="margin container center">
		...
		<section id="team">
			...
			<article>
				<div class="margin container center clearfix">
					...
					<ul class="team">
						<li>
							...
							<h5>Tina</h5>
							<p class="title">Finacial Manager</p>
							<p class="info">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor  ut labore eturet dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						</li>
						<li>
						...
						<li>
							...
							<h5> Elzey</h5>
							<p class="title">Marketing Executive</p>
							<p class="info">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor  ut labore eturet dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						</li>
						<li>
		...
		<section id="mission" class="container">
			...
			<article class="clearfix">
				<div class="left">
					<h2><span class="underline">Our Mission</span></h2>
