$(document).ready(function(){
	...
	$(".nav li a").each(function() {							//
		if (str.indexOf(this.href.toLowerCase()) > -1) {		//
			$("a.current").removeClass("current");				//compares page url with anchor in the html in nav section 
			$(this).addClass("current");						//and if both match it applies .current class to that 
		}														//.nav li a item and removes that class from siblings
	});															//
